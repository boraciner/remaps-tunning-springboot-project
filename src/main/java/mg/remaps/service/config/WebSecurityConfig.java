...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
         ...
         .authorizeRequests()
	        ...
	        .antMatchers("/anouncement").permitAll()
	        .antMatchers("/chiptunning").permitAll()
	        .antMatchers("/dsgtunning").permitAll()
	        .antMatchers("/gizliozellikler").permitAll()
	        .antMatchers("/gucartisihesaplama").permitAll()
	        .antMatchers("/tumbayiler").permitAll()
	        .antMatchers("/contact-1").permitAll()
